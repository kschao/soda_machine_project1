...
class SodaMachine:
    ...
    def begin_transaction(self, customer):  # removed user_interface param
    ...
    def run_transaction(self, customer):  # removed user_interface line 38
    ...
    # add user_interface param line 50
    ...
    def gather_change_from_register(self, change_value):  # add colon
        change_list = []
    ...
    def calculate_coin_value(self, coin_list): # remove total value 
        total_value = 0  #add total value = 0
    ...
    def deposit_coins_into_register(self, coins_list):
        ...
        for coin in coins_list: #remove self 
            self.register.append(coin) #change variable to coin
